...
internal fun sampleDemos(): List<SampleComponentDemo> =
    listOf(
        ...
        SampleComponentDemo(
            ...
            category = "Actions",
            description = "Floating action button pairing an icon with a visible label.",
            content = { ExtendedFloatingActionButtonPage() },
        ),
        SampleComponentDemo(
            id = "single-choice-segmented-button-row",
            title = "SingleChoiceSegmentedButtonRow",
            category = "Actions",
            description = "Material 3 connected segmented buttons for choosing one option.",
            content = { SingleChoiceSegmentedButtonRowPage() },
        ),
        SampleComponentDemo(
            id = "adaptive-nav-scaffold",
            title = "AdaptiveNavScaffold",
            category = "Navigation",
            description = "Scaffold that switches between a bottom TabBar and a NavRail by width.",
            content = { AdaptiveNavScaffoldPage() },
        ),
        SampleComponentDemo(
            id = "page-indicator",
            title = "PageIndicator",
            category = "Navigation",
            description = "Dot row marking the current position within a set of pages.",
            content = { PageIndicatorPage() },
        ),
        SampleComponentDemo(
            id = "section-header",
            title = "SectionHeader",
            category = "Navigation",
            description = "Heading row with an optional trailing text action.",
            content = { SectionHeaderPage() },
        ),
        SampleComponentDemo(
            id = "dialog",
            title = "Dialog",
            category = "Containers",
            description = "Alert dialog with a confirm action and optional dismiss action.",
            content = { DialogPage() },
        ),
        SampleComponentDemo(
            id = "bottom-sheet",
            title = "BottomSheet",
            category = "Containers",
            description = "Modal bottom sheet that always opens fully expanded.",
        ...
        SampleComponentDemo(
            ...
            title = "Surface",
            category = "Containers",
            description = "Flat, non-elevated container for grouping content.",
            content = { SurfacePage() },
        ),
        SampleComponentDemo(
            id = "section",
            title = "Section",
            category = "Containers",
            description = "Labeled content group with a heading and optional actions.",
            content = { SectionPage() },
        ),
        SampleComponentDemo(
            id = "adaptive-content-container",
            title = "AdaptiveContentContainer",
            category = "Layout",
            description = "Caps content at a readable max width and centers it on wide screens.",
            content = { AdaptiveContentContainerPage() },
        ),
        SampleComponentDemo(
            id = "dividers",
            title = "HorizontalDivider / VerticalDivider",
            category = "Layout",
            description = "Themed horizontal and vertical rules.",
            content = { DividersPage() },
        ),
        SampleComponentDemo(
            id = "lazy-list",
            title = "LazyList + LoadMoreFooter",
            category = "Lists",
            description = "Themed lazy column with infinite-scroll page loading.",
            content = { LazyListPage() },
        ),
        SampleComponentDemo(
            id = "cached-async-image",
            title = "CachedAsyncImage",
            category = "Media",
            description = "Async image with explicit cache policies and placeholder/error painters.",
            content = { CachedAsyncImagePage() },
        ),
        SampleComponentDemo(
            id = "badge",
            title = "Badge",
            category = "Chips & Badges",
            description = "Dot or count badge, standalone or pinned to an icon.",
            content = { BadgePage() },
        ),
    )
